...
Proposito general del programa: implementacion del algoritmo middle el cual dado un numero S y un arreglo de numeros, busca
la suma optima para alcanzar S o acercarce los mas posible.
Complejidad: O(2n)
*/
...
int main()
{
    ...
    n = inputValidation(n);
    cout<<"Ingrese el objetivo de suma:";
    S = inputValidation(S);
    ll a[n];
    ...
    ll S = 10;
    */
    printf("El valor mas grande, menor o igual a S que se puede sumar es ""%lld\n", solveSubsetSum(a,n,S));
    return 0;
}
